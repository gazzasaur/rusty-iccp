...
impl ConnectionRequest {
    pub fn new(source_reference: u16, destination_reference: u16, preferred_class: ConnectionClass, options: Vec<ConnectionOption>, parameters: Vec<CotpParameter>, user_data: &[u8]) -> TransportProtocolDataUnit {
        TransportProtocolDataUnit::CR(Self { source_reference, destination_reference, preferred_class, options, parameters, user_data: user_data.into() })
    }
}
