...
## References
* [X.226](https://www.itu.int/rec/T-REC-X.226/)

## Examples

Examples may be found in the [examples](https://github.com/gazzasaur/rusty-iccp/blob/main/rusty-copp/examples) directory. Basic useage is shown below.
