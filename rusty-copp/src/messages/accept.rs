...
impl AcceptMessage {
    ...
    pub(crate) fn responding_presentation_selector(&self) -> Option<&Vec<u8>> {
        self.responding_presentation_selector.as_ref()
    }

    pub(crate) fn context_definition_result_list(&self) -> &PresentationContextResultType {
        &self.context_definition_result_list
    }
