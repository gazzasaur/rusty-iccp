...
use crate::{
    CospError,
    message::{CospMessage, disconnect::DisconnectMessage},
    packet::{
...
pub(crate) async fn send_disconnect(writer: &mut impl CotpWriter, user_data: Option<Vec<u8>>) -> Result<(), CospError> {
